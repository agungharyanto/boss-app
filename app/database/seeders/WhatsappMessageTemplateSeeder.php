...
class WhatsappMessageTemplateSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            WhatsappEventType::ReferrerActionOtp->value => 'Halo {referrer_name}, kode verifikasi Anda: {otp_code}. Kode ini untuk mengonfirmasi pencatatan titip pembayaran pelanggan *{customer_name}*. Berlaku {otp_minutes} menit. JANGAN bagikan kode ini ke siapa pun — {company_name}.',
        ];
