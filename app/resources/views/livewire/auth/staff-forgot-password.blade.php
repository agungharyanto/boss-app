<div>
    ...
    @if ($stage === 'phone')
        <p class="text-sm text-gray-500 mb-4">{{ __('Masukkan Nomor HP akun staff Anda. Kode verifikasi akan dikirim ke WhatsApp nomor tersebut.') }}</p>
    ...
    <div class="mt-4 text-sm">
        <a href="{{ route('login') }}" class="text-blue-600 hover:underline">{{ __('Kembali ke halaman login') }}</a>
    </div>
</div>
