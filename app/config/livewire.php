...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // v0.16.0 Langkah 6 — raised from Livewire's own 12MB default to
        // 20MB so it agrees with PHP's upload_max_filesize (20M, see
        // docker/php/conf.d/zz-boss-uploads.ini). A high-res phone photo
        // can exceed 12MB; hitting this temp-upload rule produces the
        // exact same "failed to upload" symptom as the PHP limit did.
