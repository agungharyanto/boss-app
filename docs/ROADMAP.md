...
| v0.7.0  | GenieACS                 | Binding ONT, SSID/password, RX power, reboot, provisioning |
| v0.8.0  | LibreNMS & Graph         | Device monitoring, graph, alert, dashboard network    |
| v0.9.0  | Commission               | Eligibility, approval, payment, clawback              |
| v0.10.0 | Outage Engine            | ONT down detection, korelasi area, incident, maintenance |

Kita **tidak** loncat versi. Setiap versi selesai penuh (lihat Definition of
Done di `RULES.md`) sebelum lanjut ke versi berikutnya.
